<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ContactDetails.ascx.cs" Inherits="JobFair.UserControls.Recruiter.ContactDetails" %>
...
<div class="container">
    <div class="table">
        <table>
            ...
            <tr>
                <td>
                    <span>Personal Email Id</span></td>
                <td>
