<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TechnicalSkills.ascx.cs" Inherits="JobFair.UserControls.Recruiter.RE_TechnicalSkills" %>
...
<div>
       <h3>Technical Skills</h3>
        ...
        <tr>
            <td colspan="4">
                <asp:Button ID="Btngridsave" runat="server" Text="Save" OnClick="btnSaveSkills_Click" />
            </td>
        </tr>
    </table>
            <tr>
