...
<body>
    <form id="frmManageClient" runat="server">
        ...
        <div id="divMain" runat="server" style="min-height: 500px; width: 100%; padding: 10px">
            ...
            <asp:LinkButton ID="lnkBtnClientDetails" runat="server" Text="Add New Client" OnClick="lnkBtnClientDetails_Click" OnClientClick="SetTarget();" Font-Bold="true" style="align-content:center"></asp:LinkButton>
            ...
            <asp:Repeater ID="repClientDetails" runat="server">
                ...
                <ItemTemplate>
                     <table style="background-color: #EBEFF0; border-top: 1px dotted #df5015; border-bottom: 1px solid #df5015; float: left; width: 60%">
                        ...
                        <tr>
                            <td>Client Name:
                                <asp:Label ID="lblClientName" runat="server" Text='<%#Eval("ClientName") %>' Font-Bold="true" /></td>
                        </tr>
                        <tr>   
                         <td>Client Profile:
                                        <asp:Label ID="lblClientProfile" runat="server" Font-Bold="true" Text='<%#Eval("ClientProfile") %>' /></td>
                        </tr>
                    </table>
             ...
             <table style="background-color: #EBEFF0; border-top: 1px dotted #df5015; border-bottom: 1px solid #df5015; float: right; width: 40%">
                        ...
                        <tr>
                            <td>
                                <asp:LinkButton ID="lnkBtnDeleteClient" runat="server" Text="Delete Job" OnClick="lnkBtnDeleteClient_Click" OnClientClick="SetTarget();"></asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            <td>
