...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="4" Width="900px">
                ...
                <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="Personal Details">
                    <ContentTemplate>
                        <cc1:TabContainer ID="TabContainer2" runat="server" ActiveTabIndex="2" Width="500px">
                                ...
                                <ContentTemplate>
                                    ...
                                    <table class="auto-style1">
                                        ...
                                        <tr>
                                            <td>State</td>
                                            <td>
                                                <asp:Label ID="lblPresentState" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>City</td>
                                        ...
                                        <tr>
                                            <td>Area</td>
                                            <td>
                                                <asp:Label ID="lblPresentArea" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Pincode</td>
                                        ...
                                        <tr>
                                            <td>Area</td>
                                            <td>
                                                <asp:Label ID="lblPermanentArea" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Pincode</td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <asp:Label ID="lblMaritalState" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <cc1:TabPanel ID="TabPanel9" runat="server" HeaderText="Affirmative Details">
                                <ContentTemplate>
                                    ...
                                    <table class="auto-style1">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblLanguageFirst" runat="server"></asp:Label>
                                            </td>
                                            <td>

                                                <asp:Label ID="lblProficiencyFirst" runat="server"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="chkReadFirst" runat="server" Enabled="False" />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="chkWriteFirst" runat="server" Enabled="False" />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="chkSpeakFirst" runat="server" Enabled="False" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblLanguageSecond" runat="server"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblProficiencySecond" runat="server"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="chkReadSecond" runat="server" Enabled="False" />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="chkWriteSecond" runat="server" Enabled="False" />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="chkSpeakSecond" runat="server" Enabled="False" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblLanguageThird" runat="server"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblProficiencyThird" runat="server"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="chkReadThird" runat="server" Enabled="False" />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="chkWriteThird" runat="server" Enabled="False" />
                                            </td>
                                            <td>
                                                <asp:CheckBox ID="chkSpeakThird" runat="server" Enabled="False" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Physically Challenged</td>
                                            <td colspan="5">
                                                <asp:Label ID="lblPhysicallyChallenged" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Description</td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="5">
                                                <asp:Label ID="lblSportsDescription" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Hobbies</td>
                                        ...
                                        <tr>
                                            <td>USA Permit</td>
                                            <td colspan="5">
                                                <asp:Label ID="lblUSAPermit" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Other Permit</td>
                                            <td colspan="5">
                                                <asp:Label ID="lblOtherPermit" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </ContentTemplate>
                        ...
                        <asp:Repeater ID="rptrTechnicalSkills" runat="server">
                            ...
                            <ItemTemplate>
                                <tr style="background-color: #ffffff">
                                    <td>
                                        <asp:Label ID="lblTechnicalSkills" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "TechnicalSkillName")%>'></asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblFromDate" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "FromDate")%>'></asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblTillDate" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "TillDate")%>'></asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblProficiency" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Proficiency")%>'></asp:Label>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <table>
                                            ...
                                            <tr>
                                                <td>Team Size </td>
                                                <td>
                                                    <asp:Label ID="lblTeamSize" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "TeamSize")%>'></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Skill Used </td>
                                            ...
                                            <tr>
                                                <td>Degree </td>
                                                <td>
                                                    <asp:Label ID="lblDegree" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ProjectLink")%>'></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
