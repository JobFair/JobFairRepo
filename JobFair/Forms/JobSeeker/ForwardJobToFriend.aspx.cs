...
namespace JobFair.Forms.JobSeeker
{
    public partial class ForwardJobToFriend : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            DateTime postedDate;
            string strBody = "", jobTitle, experience, minSalary, maxSalary, companyName, link, industryId, jobLocationCity;
            ...
            msg.Subject = "Your Friend has forwarded you the Job: "+jobTitle+" at "+companyName ;
