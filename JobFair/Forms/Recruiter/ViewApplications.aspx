<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewApplications.aspx.cs" Inherits="JobFair.Forms.Recruiter.ViewApplications" %>
...
<body>
    ...
    <div>
            ...
            <asp:Repeater ID="rptrviewapplication" runat="server" >
                <HeaderTemplate>
