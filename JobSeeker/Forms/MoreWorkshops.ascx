...
<table class="auto-style1">
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label1" runat="server" Text="Workshop Name"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label2" runat="server" Text="Institute"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label3" runat="server" Text="Duration"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label4" runat="server" Text="Year of Completion"></asp:Label></td>
        <td>
