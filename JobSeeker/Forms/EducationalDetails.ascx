...
<%@ Register Src="~/JobSeeker/Forms/MoreCertifications.ascx" TagName="MoreCertification" TagPrefix="Certification" %>
<%@ Register Src="~/JobSeeker/Forms/MoreWorkshops.ascx" TagName="MoreWorkshops" TagPrefix="Workshops" %> 
...
<table class="auto-style1">
    <tr>
        <td class="auto-style2"> <asp:Label ID="lblHQ" runat="server" Text="Qualification"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="lblHQstat" runat="server" Text="Status"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="lblHQYear" runat="server" Text="Year of Completion"></asp:Label></td>
        <td>
            <asp:TextBox ID="txtHQyear" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="auto-style2"> <asp:Label ID="lblHQUniversity" runat="server" Text="University"></asp:Label></td>
        <td>
...
<table class="auto-style1">
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label1" runat="server" Text="Qualification"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label2" runat="server" Text="Status"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label3" runat="server" Text="Year of Completion"></asp:Label></td>
        <td>
            <asp:TextBox ID="txtPHDYear" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label4" runat="server" Text="University"></asp:Label></td>
        <td>
...
<table class="auto-style1">
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label5" runat="server" Text="Qualification"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label6" runat="server" Text="Status"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label7" runat="server" Text="Year of Completion"></asp:Label></td>
        <td>
            <asp:TextBox ID="txtMdYear" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label8" runat="server" Text="University"></asp:Label></td>
        <td>
...
<table class="auto-style1">
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label9" runat="server" Text="Qualification"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label10" runat="server" Text="Status"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label11" runat="server" Text="Year of Completion"></asp:Label></td>
        <td>
            <asp:TextBox ID="txtPGDYear" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label12" runat="server" Text="University"></asp:Label></td>
        <td>
...
<table class="auto-style1">
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label13" runat="server" Text="Qualification"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label14" runat="server" Text="Status"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label15" runat="server" Text="Year of Completion"></asp:Label></td>
        <td>
            <asp:TextBox ID="txtBDYear" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label16" runat="server" Text="University"></asp:Label></td>
        <td>
...
<table class="auto-style1">
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label17" runat="server" Text="Qualification"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label18" runat="server" Text="Status"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label19" runat="server" Text="Year of Completion"></asp:Label></td>
        <td>
            <asp:TextBox ID="txtUGDYear" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label20" runat="server" Text="University"></asp:Label></td>
        <td>
...
<table class="auto-style1">
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label22" runat="server" Text="Status"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label23" runat="server" Text="Year of Completion"></asp:Label></td>
        <td>
            <asp:TextBox ID="txtHSCYear" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label24" runat="server" Text="University/Board"></asp:Label></td>
        <td>
...
<table class="auto-style1">
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label26" runat="server" Text="Status"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label27" runat="server" Text="Year of Completion"></asp:Label></td>
        <td>
            <asp:TextBox ID="txtSSCYear" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label28" runat="server" Text="University/Board"></asp:Label></td>
        <td>
...
<table class="auto-style1">
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label29" runat="server" Text="Certificate"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label30" runat="server" Text="Institute"></asp:Label></td>
        <td>
            <asp:TextBox ID="txtCertificationInstitute" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label31" runat="server" Text="Year of Completion"></asp:Label></td>
        <td>
            <asp:TextBox ID="txtCertificationYear" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label32" runat="server" Text="Grade"></asp:Label></td>
        <td>
...
<table class="auto-style1">
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label33" runat="server" Text="Workshop Name"></asp:Label></td>
        <td>
    ...
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label34" runat="server" Text="Institute"></asp:Label></td>
        <td>
            <asp:TextBox ID="txtWorkshopInstitute" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label35" runat="server" Text="Duration"></asp:Label></td>
        <td>
            <asp:TextBox ID="TxtWrkspDuration" runat="server"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="auto-style2"> <asp:Label ID="Label36" runat="server" Text="Year of Completion"></asp:Label></td>
        <td>
